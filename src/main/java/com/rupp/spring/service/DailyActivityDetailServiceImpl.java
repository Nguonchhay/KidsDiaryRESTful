...
@Service("userService")
public class DailyActivityDetailServiceImpl implements UserService {
    private static final Logger logger = LoggerFactory.getLogger(DailyActivityDetailServiceImpl.class);
