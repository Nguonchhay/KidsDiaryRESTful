...
public class DailyActivityDetailDaoImpl implements DailyActivityDao {
    private static final Logger LOG = LoggerFactory.getLogger(DailyActivityDetailDaoImpl.class);
    
    private JdbcTemplate jdbcTemplate;
    
    @Autowired
    public DailyActivityDetailDaoImpl(DataSource dataSource) {
